...
class Temperaturas: #definimos la clase
    ...
    def convertiryBuscar(self): #metodo convertit y buscar
        ...
        maximo = max(datos.items(), key=lambda x: x[1]) #busca el mayor dato posible, items()Devuelve una lista de tuplas, cada tupla se compone de dos elementos: el primero será la clave y el segundo, su valor.
    ...
    def promedio(self): #metodo promedio
        self.promedio_centigrados=sum(self.centigrados)/contador#el calcula el promedio en °c
        #sum() suma todos los numeros de una tupla siempre y cuando sea un dato numerico
        self.promedio_farentheit=sum(self.farentheit)/contador #calcula el promedio en °f
        print("El promedio en farentheit es de "+str(self.promedio_farentheit)+"\n") #imprime el promedio de los °c
        print("El promedio en centigrados es de "+str(self.promedio_centigrados)+"\n")#imprime el pormedio de los °f
    def archivo(self): #metodo archivo 
        abrir=open("Temperaturas.txt","a") #abre el archivo en modo append o agregar 
        abrir.write("El promedio en centigrados es de "+str(self.promedio_centigrados)+"\n") #agrega el promedio de los °c
        abrir.write("El promedio en farentheit es de "+str(self.promedio_farentheit)+"\n")#agrega el promedio de los °f
